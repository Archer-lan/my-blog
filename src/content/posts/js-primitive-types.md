---
title: JS 数据类型：基本类型、引用类型与存储区别
date: 2026-03-30
description: 梳理 JavaScript 六大基本类型（Number/String/Boolean/Undefined/Null/Symbol）与引用类型（Object/Array/Function），以及栈堆存储与赋值行为差异。
category: JavaScript
tags: [JavaScript, 数据类型, 内存]
lang: zh
draft: false
---
